...
class SliceDataset(Dataset):
    ...
    """
    def __init__(self, args, data, char_list, block_size, prop_list = None, crystal_list = None):
    ...
    def __getitem__(self, idx):
        slices, prop, crystal= self.data[idx], self.prop_list[idx], self.crystal_list[idx]   # self.prop.iloc[idx, :].values  --> if multiple properties

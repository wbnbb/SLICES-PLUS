...
if __name__ == '__main__':
    ...
    tconf = TrainerConfig(max_epochs=args.max_epochs, batch_size=args.batch_size, learning_rate=args.learning_rate,
                            lr_decay=True, warmup_tokens=0.1*len(slices_trian)*max_len,
                            final_tokens=args.max_epochs*len(slices_trian)*max_len,num_workers=10, 
                            ckpt_path=f'./cond_gpt/weights/weights2.ckpt', block_size=max_len, generate=False)

    trainer = Trainer(model, train_datasets,

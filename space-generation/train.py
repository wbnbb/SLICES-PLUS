...
if __name__ == '__main__':
    ...
    train_datasets = SliceDataset(args, slices_train, char_list, max_len, space_train) # save for check_novelty
    valid_datasets = SliceDataset(args, slices_test, char_list, max_len, space_test)

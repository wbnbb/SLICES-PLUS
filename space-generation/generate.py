...
if __name__ == '__main__':
        ...
        parser.add_argument('--gen_size', type=int, default = 500, help="number of times to generate from a batch", required=False)
        parser.add_argument('--vocab_size', type=int, default = 125, help="size of vocabs", required=False)  # 97 including padding code "<"
        ...
        parser.add_argument('--num_classes', type=int, default = 7, help="number of space systems", required=False)
        ...
        for i in tqdm(range(gen_iter)):
                ...
                y = model.sample(x, args.block_size, temperature=1.2, do_sample=True, top_k=0.0, top_p=0.9, crystal=crystal)  
                for gen_mol in y:
        ...
        cry_dict = []
        for i in slices:
                cry_dict.append({'crystal_system': crystal_system, 'slices': i})
